...
n1, n2, n3 = [100,4,4] #size of simulation cell
period = 2 #SL period length = Lx of 1 unit cell
dk = 250 #k space mesh, number of points between speciak k points

steps = 200000 #run time
...
num, pos, masses, uc, types, a = mod.makeSL(n1,n2,n3,period,element='si/ge')
