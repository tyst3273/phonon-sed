...
"""
### INPUT PARAMETERS ###
# You may have to change some of the parameters below to make this work. Check the
# documentation. The individual functions should be fairly self explanatory. 
