...
mod.tic()
mod.log('\n\tSi, 8 atom cubic cell\n\t04.18.2019\n'
        '\tnx, ny, nz = 50x1x1, supercell = 2x2x2\n',new='yes')
...
u1, u2, u3 = [2,2,2] #size of supercell
...
num, pos2, masses, uc, basis, a = mod.makeAlloy(n1,n2,n3,u1,u2,u3,0.25)
...
prim[:,0] = prim[:,0]*a*u1 #a1
prim[:,1] = prim[:,1]*a*u2 #a2
prim[:,2] = prim[:,2]*a*u3 #a3
