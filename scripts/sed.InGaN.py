...
mod.tic()
mod.log('\n\tIn_xGa(1-)N alloy, x = 0.25 ortho cell\n\t04.17.2019\n'
        '\t2x2x72 structure\n',new='yes')
#description of system configuration for record keeping

outfile = 'InGaN.random.alloy.0.25x'
velsfile = 'vels.dat'
...
n1, n2, n3 = [2,2,72] #size of simulation cell
...
num, pos2, masses, uc, basis, a, c = mod.makeInGaN(n1,n2,n3,x=0.25)
x = a*np.sqrt(3)
y = a
z = c
